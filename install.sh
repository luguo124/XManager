...
if [ ! -d /etc/Xray ];then
	...
	if [ ! -f /etc/Xray/dns.json ];then
		wget -q https://raw.githubusercontent.com/xcode75/XManager/backend/dns.json -O /etc/Xray/dns.json
	fi
	if [ ! -f /etc/Xray/rulelist ];then
		wget -q https://raw.githubusercontent.com/xcode75/XManager/backend/rulelist -O /etc/Xray/rulelist
	fi
...
if [ ! -f /usr/bin/Xray ];then
	wget -q https://raw.githubusercontent.com/xcode75/XManager/backend/Xray -O /usr/bin/Xray
...
#	if [ ! -d /etc/caddy ];then
#		mkdir -p /etc/caddy	
#		wget -q https://raw.githubusercontent.com/xcode75/XManager/master/backend/caddy -O /usr/bin/caddy
...
ConnetionConfig:
  ...
  ConnIdle: 1 # Connection idle time limit, Second
